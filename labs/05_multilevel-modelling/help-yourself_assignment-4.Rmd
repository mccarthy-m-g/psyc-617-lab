...
Just wanted to share this paper by Jonas Kristoffer Lindeløv on why you might want to use a GLMER for reaction time data instead of a model that assumes your errors are normally distributed <https://lindeloev.github.io/shiny-rt/>. Not everything we study is best characterized by a normal distribution, and that shouldn't necessarily be your go to choice just because your stats education focused on it.
